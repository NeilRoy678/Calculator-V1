...
class Panel1(wx.Panel):
    def __init__(self,parent):
       ...
       gs.Add(button1,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button2,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button3,0,wx.ALL|wx.EXPAND,5)
       gs.Add(wx.StaticText(self),wx.EXPAND,5)
       gs.Add(button4,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button5,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button6,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button7,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button8,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button9,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button10,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button11,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button12,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button13,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button14,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button15,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button16,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button17,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button18,0,wx.ALL|wx.EXPAND,5)
       gs.Add(button19,0,wx.ALL|wx.EXPAND,5)
       ms.Add(gs)
       self.SetSizer(ms)
